...
#    "open_gemini_app": genai.types.Tool(function_declarations=[genai.types.FunctionDeclaration(name="open_gemini_app", description="Opens the Gemini app using uiautomator2. Requires uiautomator2 library and atx-agent to be installed and running.", parameters={"type": "object", "properties": {"package_name": {"type": "string", "default": "com.google.android.apps.bard"}}, "required": []})]),
#    "android_ui_find_and_tap_text": genai.types.Tool(function_declarations=[genai.types.FunctionDeclaration(name="android_ui_find_and_tap_text", description="Finds a UI element by text and taps it.", parameters={"type": "object", "properties": {"text": {"type": "string"}, "timeout": {"type": "number", "format": "float", "default": 10}}, "required": ["text"]})]),
#    "android_ui_long_press_text": genai.types.Tool(function_declarations=[genai.types.FunctionDeclaration(name="android_ui_long_press_text", description="Finds a UI element by text and performs a long press on it.", parameters={"type": "object", "properties": {"text": {"type": "string"}, "duration": {"type": "number", "format": "float", "default": 1.0}, "timeout": {"type": "number", "format": "float", "default": 10}}, "required": ["text"]})]),

#    "execute_puppeteer_script": genai.types.Tool(function_declarations=[genai.types.FunctionDeclaration(name="execute_puppeteer_script", description="Executes a Puppeteer script for browser automation (screenshot, get_html).", parameters={"type": "object", "properties": {"url": {"type": "string"}, "action": {"type": "string", "default": "screenshot"}, "output_file": {"type": "string", "default": "screenshot.png"}}, "required": ["url"]})]),
...
#    "droidrun_portal_adb_command": genai.types.Tool(function_declarations=[genai.types.FunctionDeclaration(name="droidrun_portal_adb_command", description="Interacts with Droidrun-Portal via ADB commands.", parameters={"type": "object", "properties": {"portal_path": {"type": "string"}, "action": {"type": "string", "default": "query"}, "data": {"type": "object"}}, "required": ["portal_path"]})]),
